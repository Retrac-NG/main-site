...
const Signup = () => {
  ...
  style={{
    ...
    <form className='flex flex-col gap-4 justify-center items-center w-full bg-slate-100 border-2 py-3 px-10 rounded-2xl max-w-md h-auto'>
        ...
        <Link href='#' passHref>
          <a className='w-full text-center bg-green-500 py-2 rounded-lg shadow-lg text-gray-50 hover:bg-green-600 font-medium transition-all duration-300'>
            Login
                    ...
                    {/* Terms and Condition */}
        <p className='text-sm text-center text-gray-700'> by Signing up you agree to our 
        <Link href="#" passHref>
             <a className='text-green-500 cursor-pointer text-sm '> Terms and Conditions </a>
             </Link>
             and our 
          <Link href="#" passHref>
             <a className='text-green-500 cursor-pointer text-sm'> Privacy Policy</a> 
        </Link>
        </p>
        ...
        <p className='text-sm text-center text-gray-700'>
            ...
            <Link href="/auth/login" passHref>
              <a className='text-green-500 cursor-pointer text-sm'> Login</a>
            </Link>
        </p>
